...
import static software.amazon.awssdk.benchmark.utils.BenchmarkCallableFactory.callableOfHttpClient;
...
public class ApiCallHttpClientBenchmark {
    ...
    @Param( {"ApacheHttpClient", "UrlConnectionHttpClient"})
    ...
    public void setup() throws Exception {
        ...
        mockServer.start();
        callable = callableOfHttpClient(clientType);
    }
